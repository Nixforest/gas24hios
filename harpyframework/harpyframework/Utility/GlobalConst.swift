...
public class GlobalConst {    
    ...
    public static var LEVEL_GAS_LEVER3                = ColorFromRGB().getColorFromRGB(0xFF4112)
    public static var LEVEL_GAS_LEVER4                = ColorFromRGB().getColorFromRGB(0xFF671D)
    public static var LEVEL_GAS_LEVER6                = ColorFromRGB().getColorFromRGB(0xFF9A2C)
    public static var LEVEL_GAS_LEVER7                = ColorFromRGB().getColorFromRGB(0xFFB333)
    public static var LEVEL_GAS_LEVER8                = ColorFromRGB().getColorFromRGB(0xFFCA3B)
    public static var LEVEL_GAS_LEVER9                = ColorFromRGB().getColorFromRGB(0xFFE142)
    public static var LEVEL_GAS_LEVER10                = ColorFromRGB().getColorFromRGB(0xFFF17F)
