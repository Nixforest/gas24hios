...
public class BaseModel: NSObject {
    ...
    /** Shared string */
    public var sharedDate:                  String              = DomainConst.BLANK
    /** Shared string */
    public var sharedDays:                  String              = DomainConst.BLANK
    /** Shared string */
    public var sharedHour:                  String              = DomainConst.BLANK
    /** Shared string */
    public var sharedCode:                String              = DomainConst.BLANK
    //public var dataTimer: ForecastBean  = ForecastBean()
    //--
    /** Shared string */
    public var sharedIdTimer:                String              = DomainConst.BLANK
    /** Shared 2 string */
