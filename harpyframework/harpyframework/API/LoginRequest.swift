...
//    }
     ...
     */
    func setData(username: String, password: String, token: String , uid: String) {
...
//        }
    ...
    public static func requestLogin(action: Selector, view: BaseViewController,
                                    ...
                                    token: String = DomainConst.BLANK, uid: String = DomainConst.BLANK) {
//        // Show overlay
//        LoadingView.shared.showOverlay(view: view.view)
        let request = LoginRequest(url: DomainConst.PATH_SITE_LOGIN,
                                   reqMethod: DomainConst.HTTP_POST_REQUEST,
                                   view: view)
        request.setData(username: username, password: password, token: token, uid: uid)
